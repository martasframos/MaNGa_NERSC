...
def getting_data(i_obs):
    ...
    import pandas as pd
    import numpy as np
    PlateIFU=[ifu_pl[i_obs]]
    dataframe=pd.DataFrame(PlateIFU, columns=['Spectra'])
    dataframe['ratio']=properties[i_obs][2]
    ...
    dataframe.to_csv('/global/homes/m/marta_r/MaNGa_files/Internship_fits.csv', mode='a', header=False)
